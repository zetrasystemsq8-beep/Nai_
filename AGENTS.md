...
**nai** — Production-ready Flutter scaffold generated by the zetra engine 

Generated by [FlutterInit](https://flutterinit.com). Package: `com.zetra.nai`.
...
| ScreenUtil | yes |
| Localization | `easy_localization` (en, es, fr, de, it, ar, ja, zh, ru, pt) |
...
- Primary import barrel: `package:nai/src/imports/imports.dart`.
